...
class BiCUTModel(BaseModel):
    """
    class for BiCUT implementation: augment CUT by adding inverse direction
    mapping, and perform constrastive learning on domain-specific encoder embedding.
    """

    @staticmethod
    def modify_commandline_options(parser, is_train=True):
        """  Configures options specific for BiCUT model
        """
        parser.add_argument('--mode', type=str, default="SIM", choices='SIM')
